        ...
        <section className="sticky-cards">
          <div className="cards-container">
            <div className="card">
              ...
              <Image src="/assets/img1.jpg" alt="" width={600} height={600} />
            </div>
            <div className="card">
              <div className="tag">
                <p>Inner Conflict</p>
              </div>
              <Image src="/assets/img2.jpg" alt="" width={600} height={600} />
            </div>
            <div className="card">
              <div className="tag">
                <p>Fury & Flow</p>
              </div>
              <Image src="/assets/img3.jpg" alt="" width={600} height={600} />
            </div>
            <div className="card">
              <div className="tag">
                <p>Rebellion</p>
              </div>
              <Image src="/assets/img4.jpg" alt="" width={600} height={600} />
            </div>
            <div className="card">
              <div className="tag">
                <p>Liberation</p>
              </div>
              <Image src="/assets/img5.jpg" alt="" width={600} height={600} />
            </div>
          </div>
        </section>
